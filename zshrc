...
# ── Aliases ─────────────────────────────────────
# Project launchers
alias start-all="tmuxinator start inbox-shepherd && tmuxinator start identity-lab && tmuxinator start interview-prep && tmuxinator start prompt-lenses && tmuxinator start text-adventure-v2 && tmuxinator start dotfiles"
